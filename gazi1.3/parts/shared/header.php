    ...
    <div class="container">
      <div id="logo">
          ...
          <div class="container">
            <div class="navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="<?=$arts_class ?>"><a href="/section/arts">Arts & Culture</a></li>
		...
		<li class="<?=$food_class ?>"><a href="/section/food">Food</a></li>
                <li class="<?=$wespeaks_class ?>"><a href="/section/wespeaks">Letters to the Editor</a></li>
          ...
          <div class="navbar navbar-second" role="navigation">
              <div class="container">
                ...
                <ul class="nav navbar-nav" style = "margin-left: -70px">
                    ...
                    <li><a href="/wesceleb-nomination">Nominate a Student</a></li>
                  </ul>
                </div><!--/.navbar-collapse -->
              </div>
          </div>
...
<a href="https://allmylinks.com/arguspodcast" target="_blank"><i class="fa fa-podcast"> </i></a>
