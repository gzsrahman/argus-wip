...
<?php while ( have_posts() ) : the_post(); ?>
  ...
  <?php 
    ...
    if(in_category(155)) { 
  ?>
    <h4><time datetime="<?php the_time( 'Y-m-d' ); ?>" pubdate><?php the_time('F j, Y'); ?></time>
    <?php
  ...
  <?php } else { ?>
          ...
          <h4><?php the_time('F j, Y'); ?>, <?php abraham_display_author(false); ?>. <?php comments_popup_link('Leave a Comment', '1 Comment', '% Comments'); ?></h4>
          <p><?php the_excerpt(); ?></p>
  <?php } ?>
        </section>
