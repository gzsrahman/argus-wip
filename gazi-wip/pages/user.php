...
<?php get_header(); ?>
      <div class="row">
        ...
        <section>
          ...
          <h4><time datetime="<?php the_time( 'Y-m-d' ); ?>" pubdate><?php the_time('F j, Y'); ?></time> <?php abraham_display_author(false); ?>. <?php comments_popup_link('Leave a Comment', '1 Comment', '% Comments'); ?></h4>
          <p><?php the_excerpt(); ?></p>
        </section>
